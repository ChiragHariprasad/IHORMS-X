"""
IHORMS Database Models
Multi-tenant Hospital Management System
"""
from datetime import datetime
from sqlalchemy import (
    Column, Integer, String, Boolean, DateTime, ForeignKey, Numeric, Text, Date, Time, JSON, Enum as SQLEnum, Index
)
...
class Appointment(Base):
    ...
    @property
    def patient_uid(self):
        return self.patient.patient_uid if self.patient else ""

    @property
    def doctor_name(self):
        return self.doctor.full_name if self.doctor else "Unassigned"
...
class MedicalHistory(Base):
    ...
    @property
    def doctor_name(self):
        return self.appointment.doctor_name if self.appointment else None
...
class TelemetryData(Base):
    ...
    @property
    def nurse_name(self):
        return self.nurse.full_name if self.nurse else "Unknown"
...
class PharmacyOrder(Base):
    ...
    patient = relationship("Patient")
    staff = relationship("User", foreign_keys=[pharmacy_staff_id])
    ...
    def fulfilled_by(self):
        return self.staff.first_name + " " + self.staff.last_name if self.staff else None
